...
class App:
    ...
    def update_stock(self, table_name, item_id, new_stock):
        ...
        self.tabs.destroy()  # clear current tabs
        self.tabs = ttk.Notebook(self.root)  # recreate tabs
        ...
        self.tabs.pack(expand=1, fill='both')  # pack new tabs
